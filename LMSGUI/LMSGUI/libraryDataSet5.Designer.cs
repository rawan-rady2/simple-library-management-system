...
namespace LMSGUI {
    ...
    public partial class libraryDataSet5 : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public BooksRow AddBooksRow(string ISBN, string Title, string Author, string Category, decimal Price) {
...
namespace LMSGUI.libraryDataSet5TableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Books] WHERE (([ISBN] = @Original_ISBN) AND ([Title] = @Original_Title) AND ([Author] = @Original_Author) AND ((@IsNull_Category = 1 AND [Category] IS NULL) OR ([Category] = @Original_Category)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Books] ([ISBN], [Title], [Author], [Category], [Price]) VALUES" +
                " (@ISBN, @Title, @Author, @Category, @Price);\r\nSELECT ISBN, Title, Author, Categ" +
                "ory, Price FROM Books WHERE (ISBN = @ISBN)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Books] SET [ISBN] = @ISBN, [Title] = @Title, [Author] = @Author, [Category] = @Category, [Price] = @Price WHERE (([ISBN] = @Original_ISBN) AND ([Title] = @Original_Title) AND ([Author] = @Original_Author) AND ((@IsNull_Category = 1 AND [Category] IS NULL) OR ([Category] = @Original_Category)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)));
SELECT ISBN, Title, Author, Category, Price FROM Books WHERE (ISBN = @ISBN)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ISBN, Title, Author, Category, Price FROM dbo.Books";
        ...
        public virtual int Delete(string Original_ISBN, string Original_Title, string Original_Author, string Original_Category, global::System.Nullable<decimal> Original_Price) {
        ...
        public virtual int Insert(string ISBN, string Title, string Author, string Category, global::System.Nullable<decimal> Price) {
            if ((ISBN == null)) {
        ...
        public virtual int Update(string ISBN, string Title, string Author, string Category, global::System.Nullable<decimal> Price, string Original_ISBN, string Original_Title, string Original_Author, string Original_Category, global::System.Nullable<decimal> Original_Price) {
            if ((ISBN == null)) {
                throw new global::System.ArgumentNullException("ISBN");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, string Author, string Category, global::System.Nullable<decimal> Price, string Original_ISBN, string Original_Title, string Original_Author, string Original_Category, global::System.Nullable<decimal> Original_Price) {
            return this.Update(Original_ISBN, Title, Author, Category, Price, Original_ISBN, Original_Title, Original_Author, Original_Category, Original_Price);
        }
    }
