...
namespace LMSGUI {
    ...
    public partial class libraryDataSet : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public BooksRow AddBooksRow(string ISBN, string Title, string Author, string Publisher, string Category, string Status, int CopiesAvailable, int AdminID, decimal Price) {
...
namespace LMSGUI.libraryDataSetTableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Books] WHERE (([ISBN] = @Original_ISBN) AND ([Title] = @Original_Title) AND ([Author] = @Original_Author) AND ((@IsNull_Publisher = 1 AND [Publisher] IS NULL) OR ([Publisher] = @Original_Publisher)) AND ((@IsNull_Category = 1 AND [Category] IS NULL) OR ([Category] = @Original_Category)) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)) AND ((@IsNull_CopiesAvailable = 1 AND [CopiesAvailable] IS NULL) OR ([CopiesAvailable] = @Original_CopiesAvailable)) AND ((@IsNull_AdminID = 1 AND [AdminID] IS NULL) OR ([AdminID] = @Original_AdminID)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Price", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 10, 4, "Price", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Books] ([ISBN], [Title], [Author], [Publisher], [Category], [Status], [CopiesAvailable], [AdminID], [Price]) VALUES (@ISBN, @Title, @Author, @Publisher, @Category, @Status, @CopiesAvailable, @AdminID, @Price);
SELECT ISBN, Title, Author, Publisher, Category, Status, CopiesAvailable, AdminID, Price FROM Books WHERE (ISBN = @ISBN)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Price", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 10, 4, "Price", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Books] SET [ISBN] = @ISBN, [Title] = @Title, [Author] = @Author, [Publisher] = @Publisher, [Category] = @Category, [Status] = @Status, [CopiesAvailable] = @CopiesAvailable, [AdminID] = @AdminID, [Price] = @Price WHERE (([ISBN] = @Original_ISBN) AND ([Title] = @Original_Title) AND ([Author] = @Original_Author) AND ((@IsNull_Publisher = 1 AND [Publisher] IS NULL) OR ([Publisher] = @Original_Publisher)) AND ((@IsNull_Category = 1 AND [Category] IS NULL) OR ([Category] = @Original_Category)) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)) AND ((@IsNull_CopiesAvailable = 1 AND [CopiesAvailable] IS NULL) OR ([CopiesAvailable] = @Original_CopiesAvailable)) AND ((@IsNull_AdminID = 1 AND [AdminID] IS NULL) OR ([AdminID] = @Original_AdminID)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)));
SELECT ISBN, Title, Author, Publisher, Category, Status, CopiesAvailable, AdminID, Price FROM Books WHERE (ISBN = @ISBN)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Price", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 10, 4, "Price", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Price", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 10, 4, "Price", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ISBN, Title, Author, Publisher, Category, Status, CopiesAvailable, AdminID" +
        ...
        public virtual int Delete(string Original_ISBN, string Original_Title, string Original_Author, string Original_Publisher, string Original_Category, string Original_Status, global::System.Nullable<int> Original_CopiesAvailable, global::System.Nullable<int> Original_AdminID, global::System.Nullable<decimal> Original_Price) {
            ...
            if ((Original_CopiesAvailable.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[10].Value = ((int)(Original_CopiesAvailable.Value));
            }
            else {
        ...
        public virtual int Insert(string ISBN, string Title, string Author, string Publisher, string Category, string Status, global::System.Nullable<int> CopiesAvailable, global::System.Nullable<int> AdminID, global::System.Nullable<decimal> Price) {
            if ((ISBN == null)) {
        ...
        public virtual int Update(
            ...
            if ((Original_CopiesAvailable.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[19].Value = ((int)(Original_CopiesAvailable.Value));
            }
            else {
            ...
            if ((Original_AdminID.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[21].Value = ((int)(Original_AdminID.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<int> Original_AdminID, 
                    global::System.Nullable<decimal> Original_Price) {
            return this.Update(Original_ISBN, Title, Author, Publisher, Category, Status, CopiesAvailable, AdminID, Price, Original_ISBN, Original_Title, Original_Author, Original_Publisher, Original_Category, Original_Status, Original_CopiesAvailable, Original_AdminID, Original_Price);
        }
    }
